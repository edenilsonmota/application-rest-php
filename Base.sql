...
CREATE TABLE `tokens_autorizados` (
  ...
  `tokens` varchar(150) COLLATE utf8mb3_swedish_ci NOT NULL,
  `status` enum('S','N') CHARACTER SET utf8mb3 COLLATE utf8mb3_swedish_ci NOT NULL DEFAULT 'N',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tokens_UNIQUE` (`tokens`)
...
CREATE TABLE `users` (
  `id` int NOT NULL AUTO_INCREMENT,
  `login` varchar(100) COLLATE utf8mb3_swedish_ci NOT NULL,
  `userscol1` varchar(100) COLLATE utf8mb3_swedish_ci NOT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2023-10-04  0:11:44
